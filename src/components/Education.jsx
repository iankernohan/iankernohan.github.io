    ...
    <section className="education" ref={educationRef}>
      ...
      <div className="education-content">
        <FadeIn direction="right">
          ...
          <p>
            I attended Wayne State University from 2018-2022, where I graduated
            Summa Cum Laude with a Bachelors degree in Psychology and a minor in
            Philosophy. Oddly enough, it was through logic based Philosphy
            courses that I discovered my love for logic and eventually
            programming.
          </p>
        </FadeIn>
        ...
        <FadeIn>
          ...
          <p>
            Udemy is where I've learned most of what I know about programming. I
            started on Udemy with Dr. Angela Yu's{" "}
